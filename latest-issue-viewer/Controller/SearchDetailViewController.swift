...
class SearchDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        // ボタンの装飾初期値を設定する
        addStyleButton.tintColor = .white //文字色
        addStyleButton.layer.cornerRadius = 10 //角
    ...
    func judgeButtonStyle(){
        ...
        if judgeDB() {
            ...
            // isbnがマッチしたデータがあればボタンを青くする
            addStyleButton.backgroundColor = UIColor(hex: "00bfff") //背景色 00bfff[deepskyblue]
            // isbnがマッチしたデータがあればボタンテキストを変更する
